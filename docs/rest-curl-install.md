...
- In **Advanced system settings** tab, click on **Environment variables**
- Select variable named **Path** then click on **Modify**
- Write the **PHP directory full path** then click on **Ok**
- Cliquer sur **Apply**
