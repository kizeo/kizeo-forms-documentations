...
## First example : a complete function to connect to Web Service and get a token
...
## Second example : a program that sends an e-mail to a list of users
...
## Third example : a program that tells you every modification made today
