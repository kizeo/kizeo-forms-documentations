...
#### Voici un exemple de requête HTTP en PHP pour obtenir la liste de toutes les données d'un formulaire :
...
#### L'exemple suivant montre comment lire les données non lues d'un formulaire
...
#### Voici un exemple de requête HTTP en Java pour obtenir la liste de toutes les données d'un formulaire :
...
#### Voici un exemple de requête HTTP en Javascript pour obtenir la liste de toutes les données d'un formulaire :
