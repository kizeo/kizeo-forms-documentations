...
Cette fonction a une option de format. Soit _**simple**_ soit _**basic.**_ Avec _**simple**_ la requête ne retourne que le premier niveau de la donnée. Avec _**basic**_, la donnée retourne complète.
